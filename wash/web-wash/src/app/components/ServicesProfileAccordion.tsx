...
export default function ServicesProfileAccordion({ initialServices, profileId }: Props) {
            ...
            {services.length > 0 ? (
                services.map((service) => (
                    <div key={service.id} className="border-b border-gray-200">
                        <button
                            className="flex items-center justify-between w-full md:p-5 py-4 px-0 font-medium text-gray-500 hover:bg-gray-100 rounded-t-lg"
                        ...
                        >
                            ...
                            <div className="flex items-center text-left">
                                ...
                                <div className="p-2 hover:bg-gray-300 rounded-lg">
                                    <svg
                                        className={`w-5 h-5 transform transition-transform ${expandedId === service.id ? 'rotate-180' : ''
                                            }`}
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                ...
                <div className="w-full mt-10 p-8 flex-row justify-items-center">
                    <svg
                        className="justify-items-center w-full mt-10 mb-4"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="48"
                        height="48"
                    ...
                    <p className="justify-items-center mt-4 w-full text-gray-400 font-semibold text-center">
