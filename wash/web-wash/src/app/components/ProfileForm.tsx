    ...
    return (
        <div className="max-w bg-white border-none mb-10">
            <div className="min-w-full w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 text-wrap">
                    <h5 className="text-xl font-medium text-gray-900 text-center mb-10">Complete seu perfil na <span className="text-2xl text-blue-500">CarWash</span></h5>

                    <label htmlFor="cityId" className="text-sm font-medium text-gray-700">
                        <svg className="inline mr-1 pb-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                        ...
                        {showTooltipCity && (
                            <div className="absolute ml-10 mt-1 bg-gray-100 text-gray-700 text-xs rounded-lg p-3 shadow-lg z-10 w-64">
                    ...
                    <div>
                        ...
                        <input type="phone" id="phone" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="00988888888"
                            required {...register("phone")} />
                    </div>


                    <div>
                        <label htmlFor="minPrice" className="block mb-2 text-sm font-medium text-gray-900">
                            <svg className="inline pb-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                        ...
                        <input type="decimal" id="minPrice" placeholder="80" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            required {...register("minPrice")} />
                    </div>
                    <div>
                        <label htmlFor="maxPrice" className="block mb-2 text-sm font-medium text-gray-900">
                            <svg className="inline pb-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                        ...
                        <input type="decimal" id="maxPrice" placeholder="200" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            required {...register("maxPrice")} />
                    </div>

                    <div>
                        <label htmlFor="startDay" className="block mb-2 text-sm font-medium text-gray-900">
                            <svg className="inline pb-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                    ...
                    <div>
                        <label htmlFor="finalDay" className="block mb-2 text-sm font-medium text-gray-900">
                            <svg className="inline pb-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                    ...
                    <div>
                        <label htmlFor="openHour" className="block mb-2 text-sm font-medium text-gray-900">
                            <svg className="inline pb-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                    ...
                    <div>
                        <label htmlFor="closeHour" className="block mb-2 text-sm font-medium text-gray-900">
                            <svg className="inline pb-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#374151" fill="none">
                    ...
                    <div className='break-words text-wrap'>
                        ...
                        <input type="string" id="bio" placeholder="Fundada em 2024 a CarWah veio para revolucionar o mercado de Lavagens e Estéticas Automotivas..." className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-20 p-2.5"
