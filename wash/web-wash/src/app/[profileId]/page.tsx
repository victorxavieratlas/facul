...
export default async function profileDetails({
	...
	// console.log(profile)
	return (
		<div className="ml-48 mr-48 mt-4">

			<div className="max-w-full min-w-full rounded-lg shadow">
			<img className="rounded-t-lg object-cover h-96 w-full" src={profileData.images[0].url} alt="" />
				<div className="p-5">
					...
					<h3 className="mt-10 ">Descrição de {profileData.name}</h3>
