            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-auto p-4">
                ...
                <div className="flex md:order-1">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <input type="text" id="search-navbar-desk" className="block w-96 p-2 ps-10 text-sm text-gray-900 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" placeholder="Selecionar cidade" />
                    </div>
                    ...
                    {idClienteLogado ?
                        ...
                        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-2" id="navbar-search">
                            <div className="relative mt-3 md:hidden">
                                ...
                                <input type="text" id="search-navbar-moba" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                            </div>
                            <ul className="flex flex-col p-4 md:p-0 mt-4 mr-12 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-gray-200">
                                <li className="block py-2 px-3 text-white hover:bg-gray-300 rounded-lg">
                                    <a href="/cadastrar" className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">CADASTRE-SE GRÁTIS</a>
                                </li>
                                <li className="block py-2 px-3 text-white hover:bg-gray-300 rounded-lg">
