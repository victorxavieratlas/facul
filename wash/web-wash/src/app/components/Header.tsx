            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-auto p-4">
                ...
                <div className="flex md:order-1">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <input type="text" id="search-navbar" className="block w-96 p-2 ps-10 text-sm text-gray-900 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none" placeholder="Selecionar cidade" />
                    </div>
