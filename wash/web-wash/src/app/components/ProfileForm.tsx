        ...
        <div className="max-w bg-white border-none mb-10">
            <div className="min-w-full w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 text-wrap mb-4">
                    <h5 className="text-xl font-medium text-gray-500 text-center mb-10">Complete seu perfil na <span className="text-2xl text-blue-500">CarWash</span></h5>
                    ...
                    <div className="relative w-full">
                        <input
                            type="search"
                            id="cityId"
                            className="block p-3 w-full h-14 z-20 text-sm text-gray-500 bg-gray-50 rounded-lg border border-gray-300 focus:outline-none"
                    ...
                    <div>
                        ...
                        <div className="w-full">
                            <div className="inline-flex justify-end float-right ml-30 mb-4">
                                ...
                                >
                                    {/* Ícone de informação */}
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline-block mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <circle cx="12" cy="12" r="10"></circle>
                                        <line x1="12" y1="16" x2="12" y2="12"></line>
                                        <line x1="12" y1="8" x2="12" y2="8"></line>
                                    </svg>
                        ...
                        <input type="phone" id="phone" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="00988888888"
                    ...
                    <p className="font-medium text-gray-500 underline underline-offset-8 mb-6">Informações de valores</p>
                        ...
                        <input type="decimal" id="minPrice" placeholder="80" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input type="decimal" id="maxPrice" placeholder="200" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <p className="font-medium text-gray-500 underline underline-offset-8 mb-6">Informações de expediente</p>
                        ...
                        <input type="string" id="startDay" placeholder="Segunda" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input type="string" id="finalDay" placeholder="Sexta" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input type="string" id="openHour" placeholder="09:00" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div>
                        <div className="w-full">
                            <div className="inline-flex justify-end float-right ml-30 mb-4">
                                ...
                                >
                                    {/* Ícone de informação */}
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline-block" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <circle cx="12" cy="12" r="10"></circle>
                                        <line x1="12" y1="16" x2="12" y2="12"></line>
                                        <line x1="12" y1="8" x2="12" y2="8"></line>
                                    </svg>
                        ...
                        <input type="string" id="closeHour" placeholder="18:00" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            required {...register("closeHour")} />
                    </div>
                    <div className='break-words text-wrap'>
                    <p className="font-medium text-gray-500 underline underline-offset-8 mb-6">Informações do negócio</p>
                        <div className="w-full">
                            <div className="inline-flex justify-end float-right ml-30 mb-4">
                                <span
                                    className="inline-block ml-2 text-gray-500 cursor-pointer"
                        ...
                        <input type="string" id="bio" placeholder="Fundada em 2024 a CarWah veio para revolucionar o mercado de Lavagens e Estéticas Automotivas..." className="mb-4 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-20 p-2.5"
                            required {...register("bio")} />
                    </div>

                    <div>
                        <label htmlFor="image" className="block mb-2 text-sm font-medium text-gray-500">Imagem de capa</label>
                        <UploadImageInput />
                        {/* <input type="file" accept="image/*"  id="image" className="mb-10 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="https://www..."
