                    ...
                    <div key={service.id} className="border-b border-gray-200">
                        <button className="flex items-center justify-between w-full p-5 font-medium text-gray-500 hover:bg-gray-100 rounded-t-lg" onClick={() => toggleExpand(service.id)}>
                            ...
                            <div className='flex items-center text-left'>
                                ...
                                <button className="p-2 hover:bg-gray-300 rounded-lg mr-1" onClick={(e) => { e.stopPropagation(); setEditingService(service); }}>
                        ...
                        {expandedId === service.id && (
                            <div className="p-5 pb-4">
                                <p className="pb-2 font-normal text-gray-500">Descrição do serviço:</p>
                                <p className="pb-2 pl-2 font-normal text-gray-700">{service.description}</p>
                                <p className="py-1 font-normal text-gray-500">Duração em minutos:</p>
                        ...
                        {editingService && editingService.id === service.id && (
                            <div className="px-6">
                                <div className="pt-5 w-full">
                                    <p className="font-semibold text-gray-500 mb-4">Editando serviço:</p>
                                    <p className="pb-1 font-normal text-gray-500">Título do serviço:</p>
