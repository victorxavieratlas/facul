...
export default function Header() {
    return (
        <footer className="bg-gray-900 z-50">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="flex flex-col items-center justify-center ml-2">
                    <span className="text-sm text-gray-500 sm:text-center mb-6">© 2024 <a href="/" className="hover:underline">Lavar Auto</a>. Todos os direitos reservados.
                    </span>
                    <p></p>
                    <span className="text-xs text-gray-500 sm:text-center mb-2">CNPJ: 38.031.982/0001-51
                    </span>
                    <p></p>
