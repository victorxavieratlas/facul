...
export default function ContactButton2({ phone }: { phone: string }) {
    return (
        <button
            className="inline-flex items-center w-4/5 sm:w-1/3 p-3 text-sm font-medium justify-center text-center text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors duration-300"
            onClick={() => {
